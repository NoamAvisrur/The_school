...
switch ($_POST['action']){
    ...
    case 'add_new_course':
        header("location:http://localhost/TheSchool/main/index.php?subject=school");
    ...
    case 'edit_new_course':
        header("location:http://localhost/TheSchool/main/index.php?subject=school&course=" . $_POST['course_id']);
        include 'lib/Course.php';
        $image = filter_var($_FILES['pic']['name'], FILTER_SANITIZE_STRING);
        savePic ('pic');
    ...
    case 'edit_new_student':
        header("location:http://localhost/TheSchool/main/index.php?subject=school&student=" . $_POST['student_id']);
        include 'lib/Person.php';
        include 'lib/Student.php';
        $image = filter_var($_FILES['pic']['name'], FILTER_SANITIZE_STRING);
        savePic ('pic'); 
    ...
    case 'add_new_admin':
        header("location:http://localhost/TheSchool/main/index.php?subject=admin");   
        include 'lib/Person.php';
    ...
    case 'edit_new_admin':
        header("location:http://localhost/TheSchool/main/index.php?subject=admin&admin=" . $_POST['admin_id']);
        include 'lib/Person.php';
        include 'lib/Admin.php';
        $image = filter_var($_FILES['pic']['name'], FILTER_SANITIZE_STRING);
        savePic ('pic');
